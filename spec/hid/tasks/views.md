...
## initial state
The landing page displays the Human Mode logo, a tagline, and a prominent search form. The search form provides immediate visual feedback on the validity of the entered URL. Below the form, icons of supported stores (Etsy, Redbubble, Alibaba) are displayed.
